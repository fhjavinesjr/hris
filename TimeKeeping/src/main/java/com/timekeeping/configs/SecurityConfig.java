...
import com.timekeeping.propertymodels.EmployeeAPIProperties;
...
public class SecurityConfig {
    ...
    public SecurityConfig(JwtFilter jwtFilter, EmployeeAPIProperties employeeAPIProperties) {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .cors(cors -> cors.configurationSource(request -> {
                    ...
                    corsConfiguration.setAllowedOrigins(List.of("http://localhost:3000")); // Frontend URL (React/Next.js)
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers(HttpMethod.POST, employeeAPIProperties.getLogin(), employeeAPIProperties.getRegister()).permitAll()
