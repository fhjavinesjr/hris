CREATE TABLE [${primehrSchema}].rsp_position_application (
 id VARCHAR(36) NOT NULL CONSTRAINT pk_rsp_position_application PRIMARY KEY,
 agency_id VARCHAR(64) NOT NULL, applicant_id VARCHAR(36) NOT NULL, vacancy_publication_id VARCHAR(36) NOT NULL,
 application_version INT NOT NULL, status VARCHAR(20) NOT NULL, safe_status VARCHAR(30) NOT NULL,
 acknowledgment_number VARCHAR(50) NULL, privacy_notice_id VARCHAR(36) NULL, privacy_notice_version INT NULL,
 vacancy_snapshot NVARCHAR(MAX) NULL, qualification_snapshot NVARCHAR(MAX) NULL,
 competency_snapshot NVARCHAR(MAX) NULL, profile_snapshot NVARCHAR(MAX) NULL, draft_updated_at DATETIMEOFFSET NOT NULL,
 submitted_at DATETIMEOFFSET NULL, withdrawn_at DATETIMEOFFSET NULL, withdrawal_reason NVARCHAR(1000) NULL,
...
CREATE UNIQUE INDEX uk_rsp_application_acknowledgment ON [${primehrSchema}].rsp_position_application(agency_id,acknowledgment_number) WHERE acknowledgment_number IS NOT NULL;
...
CREATE TABLE [${primehrSchema}].rsp_application_document_snapshot (
 id VARCHAR(36) NOT NULL CONSTRAINT pk_rsp_application_document PRIMARY KEY,
 agency_id VARCHAR(64) NOT NULL, application_id VARCHAR(36) NOT NULL, applicant_document_id VARCHAR(36) NOT NULL,
 document_type VARCHAR(100) NOT NULL, original_filename NVARCHAR(255) NOT NULL,
 storage_provider VARCHAR(20) NOT NULL, storage_object_key VARCHAR(500) NOT NULL,
 media_type VARCHAR(150) NOT NULL, byte_size BIGINT NOT NULL, sha256_checksum VARCHAR(64) NOT NULL,
 classification VARCHAR(30) NOT NULL, display_order INT NOT NULL,
 record_version BIGINT NOT NULL DEFAULT 0, created_by VARCHAR(100) NOT NULL, created_at DATETIMEOFFSET NOT NULL,
 updated_by VARCHAR(100) NOT NULL, updated_at DATETIMEOFFSET NOT NULL,
...
CREATE TABLE [${primehrSchema}].rsp_applicant_communication (
 id VARCHAR(36) NOT NULL CONSTRAINT pk_rsp_applicant_communication PRIMARY KEY,
 agency_id VARCHAR(64) NOT NULL, application_id VARCHAR(36) NOT NULL, applicant_id VARCHAR(36) NOT NULL,
 direction VARCHAR(30) NOT NULL, channel VARCHAR(20) NOT NULL, subject NVARCHAR(300) NOT NULL,
 body NVARCHAR(4000) NOT NULL, actor VARCHAR(100) NOT NULL, occurred_at DATETIMEOFFSET NOT NULL,
 read_at DATETIMEOFFSET NULL, correlation_id VARCHAR(100) NULL,
 record_version BIGINT NOT NULL DEFAULT 0, created_by VARCHAR(100) NOT NULL, created_at DATETIMEOFFSET NOT NULL,
 updated_by VARCHAR(100) NOT NULL, updated_at DATETIMEOFFSET NOT NULL,
