CREATE TABLE [${primehrSchema}].rsp_appointment_handoff (
 ...
 schema_version INT NOT NULL, handoff_revision INT NOT NULL, current_selection_key VARCHAR(36) NULL,
 status VARCHAR(30) NOT NULL, payload_snapshot NVARCHAR(MAX) NOT NULL, payload_fingerprint VARCHAR(64) NOT NULL,
 correlation_id VARCHAR(100) NULL, receipt_id VARCHAR(36) NULL, receipt_state VARCHAR(30) NULL, receipt_record_version BIGINT NULL,
 ready_at DATETIMEOFFSET NULL, sent_at DATETIMEOFFSET NULL, acknowledged_at DATETIMEOFFSET NULL,
 cancelled_at DATETIMEOFFSET NULL, closed_at DATETIMEOFFSET NULL, last_failure NVARCHAR(1000) NULL,
...
CREATE UNIQUE INDEX uk_rsp_handoff_current ON [${primehrSchema}].rsp_appointment_handoff(agency_id,current_selection_key) WHERE current_selection_key IS NOT NULL;
...
CREATE TABLE [${primehrSchema}].rsp_appointment_handoff_attempt (
 ...
 created_by VARCHAR(100) NOT NULL, created_at DATETIMEOFFSET NOT NULL,
 updated_by VARCHAR(100) NOT NULL, updated_at DATETIMEOFFSET NOT NULL,
 handoff_id VARCHAR(36) NOT NULL, attempt_number INT NOT NULL, attempted_at DATETIMEOFFSET NOT NULL,
 endpoint_identity VARCHAR(500) NOT NULL, result_category VARCHAR(40) NOT NULL, http_status INT NULL,
 safe_diagnostic NVARCHAR(1000) NULL, payload_fingerprint VARCHAR(64) NOT NULL,
