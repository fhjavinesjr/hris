...
CREATE TABLE ${primehrSchema}.spms_policy_version (
 id VARCHAR(36) NOT NULL PRIMARY KEY, agency_id VARCHAR(64) NOT NULL, policy_id VARCHAR(36) NOT NULL,
 ...
 cycle_frequency VARCHAR(20) NOT NULL, requires_mid_cycle_review BIT NOT NULL,
 requires_self_assessment BIT NOT NULL, requires_pmt_calibration BIT NOT NULL,
 requires_acknowledgment BIT NOT NULL, requires_appeal BIT NOT NULL,
...
CREATE TABLE ${primehrSchema}.spms_cycle (
 ...
 coverage_scope VARCHAR(30) NOT NULL, status VARCHAR(20) NOT NULL, calendar_revision INT NOT NULL DEFAULT 0,
 opened_by VARCHAR(100), opened_at DATETIMEOFFSET, closed_by VARCHAR(100), closed_at DATETIMEOFFSET,
 cancelled_by VARCHAR(100), cancelled_at DATETIMEOFFSET, transition_reason VARCHAR(1000),
 record_version BIGINT NOT NULL DEFAULT 0, created_by VARCHAR(100) NOT NULL,
 created_at DATETIMEOFFSET NOT NULL, updated_by VARCHAR(100) NOT NULL, updated_at DATETIMEOFFSET NOT NULL,
...
CREATE TABLE ${primehrSchema}.spms_cycle_milestone (
 ...
 starts_at DATETIMEOFFSET NOT NULL, ends_at DATETIMEOFFSET, required BIT NOT NULL,
 display_order INT NOT NULL, instructions VARCHAR(2000), post_cycle_closeout BIT NOT NULL,
 record_version BIGINT NOT NULL DEFAULT 0, created_by VARCHAR(100) NOT NULL,
 created_at DATETIMEOFFSET NOT NULL, updated_by VARCHAR(100) NOT NULL, updated_at DATETIMEOFFSET NOT NULL,
