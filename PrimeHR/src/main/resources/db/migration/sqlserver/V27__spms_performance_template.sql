...
CREATE TABLE ${primehrSchema}.spms_template_version (
 id VARCHAR(36) NOT NULL PRIMARY KEY, agency_id VARCHAR(64) NOT NULL, template_id VARCHAR(36) NOT NULL,
 policy_version_id VARCHAR(36) NOT NULL, rating_scale_version_id VARCHAR(36) NOT NULL,
 definition_version INT NOT NULL, supersedes_id VARCHAR(36), title VARCHAR(200) NOT NULL,
 description VARCHAR(2000), form_type VARCHAR(20) NOT NULL, form_label VARCHAR(200) NOT NULL,
 legal_basis VARCHAR(1000) NOT NULL, coverage_scope VARCHAR(30) NOT NULL,
 aggregation VARCHAR(30) NOT NULL, missing_value_policy VARCHAR(20) NOT NULL, status VARCHAR(20) NOT NULL,
 structure_revision INT NOT NULL DEFAULT 0, effective_from DATE, effective_to DATE,
...
CREATE TABLE ${primehrSchema}.spms_template_section (
 id VARCHAR(36) NOT NULL PRIMARY KEY, agency_id VARCHAR(64) NOT NULL, template_version_id VARCHAR(36) NOT NULL,
 section_type VARCHAR(20) NOT NULL, section_code VARCHAR(80) NOT NULL, title VARCHAR(200) NOT NULL,
 description VARCHAR(2000), weight_percent DECIMAL(7,4) NOT NULL,
 display_order INT NOT NULL, record_version BIGINT NOT NULL DEFAULT 0,
 created_by VARCHAR(100) NOT NULL, created_at DATETIMEOFFSET NOT NULL,
 updated_by VARCHAR(100) NOT NULL, updated_at DATETIMEOFFSET NOT NULL,
...
CREATE TABLE ${primehrSchema}.spms_template_item (
 id VARCHAR(36) NOT NULL PRIMARY KEY, agency_id VARCHAR(64) NOT NULL, section_id VARCHAR(36) NOT NULL,
 indicator_version_id VARCHAR(36) NOT NULL, label_override VARCHAR(200), weight_percent DECIMAL(7,4) NOT NULL,
 required_item BIT NOT NULL, evidence_override VARCHAR(2000), display_order INT NOT NULL,
