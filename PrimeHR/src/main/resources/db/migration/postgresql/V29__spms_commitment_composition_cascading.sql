CREATE TABLE "${primehrSchema}".spms_commitment (
 id VARCHAR(36) PRIMARY KEY, agency_id VARCHAR(64) NOT NULL, assignment_id VARCHAR(36) NOT NULL,
...
CREATE TABLE "${primehrSchema}".spms_commitment_version (
 id VARCHAR(36) PRIMARY KEY, agency_id VARCHAR(64) NOT NULL, commitment_id VARCHAR(36) NOT NULL,
 assignment_id VARCHAR(36) NOT NULL, definition_version INTEGER NOT NULL, supersedes_id VARCHAR(36),
 ...
 form_label VARCHAR(200) NOT NULL, period_start DATE NOT NULL, period_end DATE NOT NULL, calendar_revision INTEGER NOT NULL,
 ...
 source_fetched_at TIMESTAMP WITH TIME ZONE NOT NULL, status VARCHAR(24) NOT NULL,
 content_revision INTEGER NOT NULL DEFAULT 0, lifecycle_revision INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE "${primehrSchema}".spms_commitment_section (
 ...
 title VARCHAR(200) NOT NULL, description VARCHAR(2000), weight_percent NUMERIC(7,4) NOT NULL, display_order INTEGER NOT NULL,
 record_version BIGINT NOT NULL DEFAULT 0, created_by VARCHAR(100) NOT NULL, created_at TIMESTAMP WITH TIME ZONE NOT NULL,
 updated_by VARCHAR(100) NOT NULL, updated_at TIMESTAMP WITH TIME ZONE NOT NULL,
...
CREATE TABLE "${primehrSchema}".spms_commitment_item (
 ...
 unit_of_measure VARCHAR(100) NOT NULL, direction VARCHAR(30) NOT NULL, weight_percent NUMERIC(7,4) NOT NULL,
 required_item BOOLEAN NOT NULL, source_requires_evidence BOOLEAN NOT NULL, source_evidence_requirement VARCHAR(2000),
 indicator_fingerprint VARCHAR(64) NOT NULL, committed_value NUMERIC(19,6), committed_from NUMERIC(19,6), committed_to NUMERIC(19,6),
 ...
 planning_remarks VARCHAR(2000), evidence_clarification VARCHAR(2000), display_order INTEGER NOT NULL,
 record_version BIGINT NOT NULL DEFAULT 0, created_by VARCHAR(100) NOT NULL, created_at TIMESTAMP WITH TIME ZONE NOT NULL,
 updated_by VARCHAR(100) NOT NULL, updated_at TIMESTAMP WITH TIME ZONE NOT NULL,
...
CREATE TABLE "${primehrSchema}".spms_commitment_cascade (
 id VARCHAR(36) PRIMARY KEY, agency_id VARCHAR(64) NOT NULL, upstream_item_id VARCHAR(36) NOT NULL,
 downstream_item_id VARCHAR(36) NOT NULL, mode VARCHAR(30) NOT NULL, share_percent NUMERIC(7,4), active BOOLEAN NOT NULL,
