CREATE TABLE "${primehrSchema}".spms_commitment_route (
 ...
 route_revision INTEGER NOT NULL, request_code VARCHAR(100) NOT NULL, business_unit_id BIGINT NOT NULL,
 organization_fingerprint VARCHAR(64) NOT NULL, route_fingerprint VARCHAR(64) NOT NULL,
 submitted_content_fingerprint VARCHAR(64) NOT NULL, submitted_content_revision INTEGER NOT NULL,
 current_level INTEGER NOT NULL, status VARCHAR(20) NOT NULL, submitted_by VARCHAR(100) NOT NULL,
 submitted_at TIMESTAMP WITH TIME ZONE NOT NULL, record_version BIGINT NOT NULL DEFAULT 0,
...
CREATE TABLE "${primehrSchema}".spms_commitment_route_step (
 ...
 route_level INTEGER NOT NULL, action_type VARCHAR(20) NOT NULL, employee_id BIGINT NOT NULL,
 ...
 decided_at TIMESTAMP WITH TIME ZONE, decision_reason VARCHAR(2000), record_version BIGINT NOT NULL DEFAULT 0,
 created_by VARCHAR(100) NOT NULL, created_at TIMESTAMP WITH TIME ZONE NOT NULL,
 updated_by VARCHAR(100) NOT NULL, updated_at TIMESTAMP WITH TIME ZONE NOT NULL,
...
CREATE TABLE "${primehrSchema}".spms_commitment_action (
 ...
 content_revision INTEGER NOT NULL, lifecycle_revision INTEGER NOT NULL, route_revision INTEGER,
 action_reason VARCHAR(2000), override_milestone VARCHAR(80), acted_at TIMESTAMP WITH TIME ZONE NOT NULL,
