...
CREATE TABLE "${primehrSchema}".spms_rating_scale_version (
 id VARCHAR(36) PRIMARY KEY, agency_id VARCHAR(64) NOT NULL, rating_scale_id VARCHAR(36) NOT NULL,
 policy_version_id VARCHAR(36) NOT NULL, definition_version INTEGER NOT NULL, supersedes_id VARCHAR(36),
 title VARCHAR(200) NOT NULL, description VARCHAR(2000), legal_basis VARCHAR(1000) NOT NULL,
 minimum_score NUMERIC(19,6) NOT NULL, maximum_score NUMERIC(19,6) NOT NULL,
 rounding_scale INTEGER NOT NULL, rounding_mode VARCHAR(20) NOT NULL, measure_type VARCHAR(30) NOT NULL,
 direction VARCHAR(30) NOT NULL, aggregation VARCHAR(30) NOT NULL, missing_value_policy VARCHAR(20) NOT NULL,
 dimension_score_source VARCHAR(30) NOT NULL, status VARCHAR(20) NOT NULL, band_revision INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE "${primehrSchema}".spms_rating_band (
 id VARCHAR(36) PRIMARY KEY, agency_id VARCHAR(64) NOT NULL, rating_scale_version_id VARCHAR(36) NOT NULL,
 code VARCHAR(80) NOT NULL, normalized_code VARCHAR(80) NOT NULL, numeric_score NUMERIC(19,6) NOT NULL,
 label VARCHAR(200) NOT NULL, lower_bound NUMERIC(19,6) NOT NULL, upper_bound NUMERIC(19,6) NOT NULL,
 display_order INTEGER NOT NULL, guidance VARCHAR(2000), record_version BIGINT NOT NULL DEFAULT 0,
 created_by VARCHAR(100) NOT NULL, created_at TIMESTAMP WITH TIME ZONE NOT NULL,
 updated_by VARCHAR(100) NOT NULL, updated_at TIMESTAMP WITH TIME ZONE NOT NULL,
