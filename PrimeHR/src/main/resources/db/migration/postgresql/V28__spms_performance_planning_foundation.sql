...
CREATE TABLE "${primehrSchema}".spms_objective_version (
 id VARCHAR(36) PRIMARY KEY, agency_id VARCHAR(64) NOT NULL, objective_id VARCHAR(36) NOT NULL,
 ...
 indicator_version_id VARCHAR(36), target_value NUMERIC(19,6), target_from NUMERIC(19,6),
 target_to NUMERIC(19,6), unit_of_measure VARCHAR(100), source_fingerprint VARCHAR(64),
...
CREATE TABLE "${primehrSchema}".spms_plan_assignment (
 ...
 status VARCHAR(20) NOT NULL, activated_by VARCHAR(100), activated_at TIMESTAMP WITH TIME ZONE,
 retired_by VARCHAR(100), retired_at TIMESTAMP WITH TIME ZONE, transition_reason VARCHAR(1000),
 record_version BIGINT NOT NULL DEFAULT 0, created_by VARCHAR(100) NOT NULL,
 created_at TIMESTAMP WITH TIME ZONE NOT NULL, updated_by VARCHAR(100) NOT NULL,
 updated_at TIMESTAMP WITH TIME ZONE NOT NULL,
...
CREATE TABLE "${primehrSchema}".spms_plan_assignment_objective (
 ...
 objective_version_id VARCHAR(36) NOT NULL, display_order INTEGER NOT NULL,
 record_version BIGINT NOT NULL DEFAULT 0, created_by VARCHAR(100) NOT NULL,
 created_at TIMESTAMP WITH TIME ZONE NOT NULL, updated_by VARCHAR(100) NOT NULL,
 updated_at TIMESTAMP WITH TIME ZONE NOT NULL,
