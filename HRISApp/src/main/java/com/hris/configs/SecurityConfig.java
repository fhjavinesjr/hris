    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .cors(cors -> cors.configurationSource(request -> {
                    ...
                    corsConfiguration.setAllowedOrigins(List.of("http://localhost:3087","http://localhost:3080","http://localhost:3081","http://localhost:3082","http://localhost:3083","http://localhost:3084","http://localhost:3085", "https://hris-znce.onrender.com")); // Frontend URL (React/Next.js)
                ...
                // This API authenticates with JWT bearer tokens, not HTTP Basic.
