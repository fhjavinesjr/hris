...
@Entity
@Table(name = "civilserviceeligibility")
public class CivilServiceEligibility implements Serializable {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "civilServiceEligibilityId")
    ...
    public CivilServiceEligibility() {

    }

    public CivilServiceEligibility(Long civilServiceEligibilityId, Long personalDataId, String careerServiceName, Double civilServiceRating, LocalDateTime dateOfExamination, String placeOfExamination, String licenseNumber, LocalDateTime licenseValidityDate) {
