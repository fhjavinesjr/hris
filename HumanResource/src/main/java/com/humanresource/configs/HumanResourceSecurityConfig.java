    ...
    public SecurityFilterChain humanresourceSecurityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .cors(cors -> cors.configurationSource(request -> {
                    ...
                    corsConfiguration.setAllowedOrigins(List.of("http://localhost:3080","http://localhost:3081","http://localhost:3082","http://localhost:3083","http://localhost:3084","http://localhost:3085","http://192.168.68.128:3082","http://192.168.68.121:3085")); // Frontend URL (React/Next.js)
