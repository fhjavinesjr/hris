CREATE TABLE [${hrmSchema}].rsp_appointment_handoff_receipt (
 ...
 schema_version INT NOT NULL, source_fingerprint VARCHAR(64) NOT NULL, selection_id VARCHAR(36) NOT NULL,
 application_id VARCHAR(36) NOT NULL, applicant_id VARCHAR(36) NOT NULL, state VARCHAR(30) NOT NULL,
 payload_snapshot NVARCHAR(MAX) NOT NULL, received_at DATETIMEOFFSET NOT NULL,
 correlation_id VARCHAR(100) NULL, source_actor VARCHAR(100) NOT NULL, record_version BIGINT NOT NULL DEFAULT 0,
